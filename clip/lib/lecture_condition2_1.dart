...
import 'package:clip/lecture_condition2_2.dart';
...
class LectureCondition2_1 extends StatefulWidget {
  const LectureCondition2_1({Key? key, required this.uid}) : super(key: key);
  final String uid;

  @override
  _LectureCondition2_1State createState() => _LectureCondition2_1State();
}

class _LectureCondition2_1State extends State<LectureCondition2_1> {
