...
class LectureCondition1_1 extends StatefulWidget {
  const LectureCondition1_1({Key? key, required this.uid}) : super(key: key);
  final String uid;

  @override
  _LectureCondition1_1State createState() => _LectureCondition1_1State();
}

class _LectureCondition1_1State extends State<LectureCondition1_1> {
