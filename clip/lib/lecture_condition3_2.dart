...
class LectureCondition3_2 extends StatefulWidget {
  const LectureCondition3_2({Key? key, required this.uid}) : super(key: key);
  final String uid;

  @override
  _LectureCondition3_2State createState() => _LectureCondition3_2State();
}

class _LectureCondition3_2State extends State<LectureCondition3_2> {
