...
import 'package:clip/lecture4all.dart';
...
class Lecture3All extends StatefulWidget {
  const Lecture3All({Key? key, required this.uid}) : super(key: key);
  final String uid;

  @override
  _Lecture3AllState createState() => _Lecture3AllState();
}

class _Lecture3AllState extends State<Lecture3All> {
                      ...
                      HCILocation()
                        ...
                        Navigator.pushReplacement(
                          ...
                          PageTransition(
                              ...
                              child: Lecture4All(uid: widget.uid),
                              inheritTheme: true,
                              ctx: context),
                        );
                      });
